...
function _emscripten_webgl_do_create_context(target, attributes) {
  ...
  contextAttributes['premultipliedAlpha'] = !!GROWABLE_HEAP_I32()[
    a + (16 >> 2)
  ];
  contextAttributes['preserveDrawingBuffer'] = !!GROWABLE_HEAP_I32()[
    a + (20 >> 2)
  ];
  var powerPreference = GROWABLE_HEAP_I32()[a + (24 >> 2)];
  contextAttributes['powerPreference'] =
    __emscripten_webgl_power_preferences[powerPreference];
  contextAttributes['failIfMajorPerformanceCaveat'] = !!GROWABLE_HEAP_I32()[
    a + (28 >> 2)
  ];
  contextAttributes.majorVersion = GROWABLE_HEAP_I32()[a + (32 >> 2)];
  contextAttributes.minorVersion = GROWABLE_HEAP_I32()[a + (36 >> 2)];
  contextAttributes.enableExtensionsByDefault = GROWABLE_HEAP_I32()[
    a + (40 >> 2)
  ];
  contextAttributes.explicitSwapControl = GROWABLE_HEAP_I32()[a + (44 >> 2)];
  contextAttributes.proxyContextToMainThread = GROWABLE_HEAP_I32()[
    a + (48 >> 2)
  ];
  contextAttributes.renderViaOffscreenBackBuffer = GROWABLE_HEAP_I32()[
    a + (52 >> 2)
  ];
  var canvas = __findCanvasEventTarget(target);
  if (!canvas) {
...
var _emscripten_atomic_add_u64 = (Module[
  '_emscripten_atomic_add_u64'
] = function () {
  return Module['asm']['fa'].apply(null, arguments);
});
var _emscripten_atomic_and_u64 = (Module[
  '_emscripten_atomic_and_u64'
] = function () {
  return Module['asm']['ga'].apply(null, arguments);
});
var _emscripten_atomic_cas_u64 = (Module[
...
var asmJsEstablishStackFrame = (Module[
  'asmJsEstablishStackFrame'
] = function () {
  return Module['asm']['Na'].apply(null, arguments);
});
