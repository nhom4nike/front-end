  ...
  (function (n) {
    ...
    function (n, f, e) {
      function h(a, c, g, m) {
        ...
        if (
          ...
          (16 == a.length || 24 == a.length || 32 == a.length)
        )
        ...
        if (
          a.constructor == Array &&
          (4 == a.length || 6 == a.length || 8 == a.length)
        ) {
          var f = y(a, m),
            q,
            e,
            ...
            finish: function (a) {
              ...
              m &&
                ...
                (a
                  ...
                  : ((a = e.length()),
                    (a = e.w(a - 1)),
                    16 < a ? (c = !1) : e.truncate(a)));
              return c;
            },
            start: function (a, c) {
              a = a || z.slice(0);
              if (a.constructor == String && 16 == a.length)
                a = l.f.createBuffer(a);
    ...
    function (n, f) {
      function e(a, b, c) {
        ...
        for (f in c) {
          ...
          try {
            ...
            if ('web' === e || 'both' === e)
              (b[0] = localStorage), (g = a.apply(this, b)), (m = !0);
          } catch (C) {
            d = C;
          }
          if (m) break;
      ...
      function r(a, b, c) {
        ...
        null === c
          ? (a = a.removeItem(b))
          : ((c = d.m(JSON.stringify(c))), (a = a.setItem(b, c)));
      ...
      d.oa = function (a) {
        ...
        if (
          (a =
            null === b
              ? null
              : { H: a, scheme: b[1], host: b[2], port: b[3], path: b[4] })
        )
          (a.h = a.host),
            a.port
        ...
        if ('object' === p(a) && null !== a)
          for (var d = 0, e = b.length; d < e; ) {
            ...
            if (d == e) a[f] = c;
              ...
              var h = f in a;
              if (!h || (h && 'object' !== p(a[f])) || (h && null === a[f]))
                a[f] = {};
              a = a[f];
            }
          }
