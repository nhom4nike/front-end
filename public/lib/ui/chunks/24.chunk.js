      ...
      e.exports = (function (e) {
        ...
        function t(e, t, r, s) {
          ...
          switch (r) {
            ...
            case 'mm':
              return t || s ? _ + (n(e) ? 'minuty' : 'minut') : _ + 'minutami';
            case 'h':
              return t ? 'hodina' : s ? 'hodinu' : 'hodinou';
            case 'hh':
              return t || s ? _ + (n(e) ? 'hodiny' : 'hodin') : _ + 'hodinami';
            case 'd':
              return t || s ? 'den' : 'dnem';
            case 'dd':
              return t || s ? _ + (n(e) ? 'dny' : 'dní') : _ + 'dny';
            case 'M':
              return t || s ? 'měsíc' : 'měsícem';
            case 'MM':
              return t || s ? _ + (n(e) ? 'měsíce' : 'měsíců') : _ + 'měsíci';
            case 'y':
              return t || s ? 'rok' : 'rokem';
            case 'yy':
              return t || s ? _ + (n(e) ? 'roky' : 'let') : _ + 'lety';
          }
        }
