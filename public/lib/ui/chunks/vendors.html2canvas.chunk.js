                        ...
                        r.textDecorationLine.forEach(function (e) {
                          switch (e) {
                            case B.TEXT_DECORATION_LINE.UNDERLINE:
                              var r = a.options.fontMetrics.getMetrics(t)
                                .baseline;
                              a.rectangle(
                                A.bounds.left,
                            ...
                            case B.TEXT_DECORATION_LINE.LINE_THROUGH:
                              var n = a.options.fontMetrics.getMetrics(t)
                                .middle;
                              a.rectangle(
                                A.bounds.left,
                  ...
                  if (E || Q(F)) {
                    var f =
                        E || F.isPositioned()
                          ...
                          : i,
                      h = new r.default(F, f, E);
                    f.contexts.push(h), d && A(g, F, h, l, w);
        ...
        f =
          ((e.parseGradient = function (A, e, t) {
            ...
            return 'linear-gradient' === n
              ...
              ? h(['to bottom'].concat(b(r.slice(3))), t, !!B)
              : 'radial-gradient' === n
